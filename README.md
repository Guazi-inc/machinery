...
[![Travis Status for Guazi-inc/machinery](https://travis-ci.org/Guazi-inc/machinery.svg?branch=master&label=linux+build)](https://travis-ci.org/Guazi-inc/machinery)
[![godoc for Guazi-inc/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/Guazi-inc/machinery/v1)
[![goreportcard for Guazi-inc/machinery](https://goreportcard.com/badge/github.com/Guazi-inc/machinery)](https://goreportcard.com/report/Guazi-inc/machinery)
[![codecov for Guazi-inc/machinery](https://codecov.io/gh/Guazi-inc/machinery/branch/master/graph/badge.svg)](https://codecov.io/gh/Guazi-inc/machinery)

[![Sourcegraph for Guazi-inc/machinery](https://sourcegraph.com/github.com/Guazi-inc/machinery/-/badge.svg)](https://sourcegraph.com/github.com/Guazi-inc/machinery?badge)
...
```sh
go get github.com/Guazi-inc/machinery/v1
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/Guazi-inc/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/Guazi-inc/machinery/v1/log` package:
